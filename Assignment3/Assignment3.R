...
for(i in 1:10){
  #includes all but i-th fold
  traindata = folds[-i]
  
  #makes the folds into one dataframe again
  traindata = do.call('rbind', traindata)
  ...
  #predicts using the fold not used in the training set
...
#average error which is used as final error
